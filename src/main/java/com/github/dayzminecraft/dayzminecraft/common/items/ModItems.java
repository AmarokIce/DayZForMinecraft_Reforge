...
import com.github.dayzminecraft.dayzminecraft.common.items.misc.ItemBloodbag;
...
public class ModItems {
    ...
    public static void loadItems() {
        ...
        registerItem(healBloodbag = new ItemBloodbag());
    ...
    */
        ...
        registerItem(drinkCanLemonSoda = new ItemDrink(6, 0.4F).setUnlocalizedName("drinkCanLemonSoda"));
        registerItem(drinkCanCola = new ItemDrink(3, 0.3F).setUnlocalizedName("drinkCanCola"));
        registerItem(drinkCanEnergyDrink = new ItemDrink().setUnlocalizedName("drinkCanEnergyDrink"));
        registerItem(drinkCanOrangeSoda = new ItemDrink(7, 0.5F).setUnlocalizedName("drinkCanOrangeSoda"));

        registerItem(drinkWhiskeyBottle = new ItemDrinkBottle(6, 0.5F, true).isAlcohol(true).setUnlocalizedName("drinkWhiskeyBottle"));
        registerItem(drinkCiderBottle = new ItemDrinkBottle(6, 0.5F, false).setUnlocalizedName("drinkCiderBottle"));
        registerItem(drinkVodkaBottle = new ItemDrinkBottle(6, 0.5F, true).isAlcohol(true).setUnlocalizedName("drinkVodkaBottle"));
    ...
    private static void registerItem(Item item) {
        GameRegistry.registerItem(item, item.getUnlocalizedName(), "DayZ");
    }
}
